  ...
  async function enviar(e: React.FormEvent) {
    ...
    try {
      ...
      const resposta = await fetch("/api/publico/cadastrar-empresa", {
        ...
        body: JSON.stringify({ ...form, sistemaTipo: "beauty" }),
      });
        ...
        <section className="relative z-10 flex items-center justify-center p-5 lg:p-10">
          ...
          >
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                <Label className="mb-2 block font-bold text-white">Sistema contratado</Label>
                <div className="flex h-14 items-center rounded-xl border border-[#f6c24a]/20 bg-[#0b111a] px-4">
                  <div>
                    <div className="font-semibold text-white">Oliver Beauty</div>
                    <div className="text-xs text-slate-400">Sistema de gestão para beleza</div>
                  </div>
                </div>
              </div>
